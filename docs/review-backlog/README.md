...
| 003 | P0 | ready | [Discovery option validation](tasks/003-discovery-option-validation.md) | 002 | 009, 015 |
| 004 | P0 | done | [Address-predicate correctness](tasks/004-address-predicate-correctness.md) | — | 005, 006 |
| 005 | P1 | ready | [Compiled command rules](tasks/005-compiled-command-rules.md) | 004 | 006, 007, 015 |
